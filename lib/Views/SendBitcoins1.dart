...
class SendBitcoins1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          color: ColorStyle.primaryWhite,
                        ),alignment: Alignment.centerRight,padding: EffectStyle.padding(0, 16, 0, 0),),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 12,),
                                    Image.asset(ImageStyle.Vector6,height: 24,),
                                  ],
                                ),
                                SizedBox(height: 14,),
    ...
    SizedBox(height: 16,),
    GradientButtonWithSendsBitcoinn(
    text: 'Send to David Applebury',
    width: MediaQuery.of(context).size.width,
    ...
    SizedBox(height: 40),
                    ...
                    // height: 20,
                    decoration: BoxDecoration(
                        color: HexColor('#041534').withOpacity(.7),
                        border: Border.all(
                            width: 1,
                            color: ColorStyle.grey.withOpacity(0.3)
                        ),
