...
import '../Controllers/CryptoMarketController.dart';
...
import '../../../Styles/ImageStyle.dart';
import '../../../Styles/TextStyles.dart';
import '../Views/CryptoNewsCell.dart';
                          ...
                          child: Container(
                            child: Text(
                              ...
                              style: TextStylesSFCompactDisplay.textStyles_20.apply(
                                color: controller.isCoins.value ? ColorStyle.primaryWhite : ColorStyle.primaryWhite.withOpacity(0.7),
                                fontWeightDelta: 2,
                              ),
                            ),
                            decoration: BoxDecoration(
                                border: Border(
                                    bottom: BorderSide(
                                        color: controller.isCoins.value ? ColorStyle.hex('#24DCE3') : Colors.transparent,
                                        width: 2
                                    )
                                )
                            ),
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  alignment: Alignment.center,
                                                  padding: EffectStyle.padding(6, 6, 4, 4),
                                                  decoration: BoxDecoration(
                                                      color: controller
                                                          .chooseSaving2[index].contains('+') ? Colors.green : Colors.red,
