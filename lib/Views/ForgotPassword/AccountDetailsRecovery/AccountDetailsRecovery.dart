...
import '../AccountDetailsRecovery/AccountDetails.dart';
import '../../../Controllers/AccountDetailsRecoveryController.dart';
import '../AccountDetailsRecovery/EnterUserID.dart';
import '../AccountDetailsRecovery/SetPassword.dart';
import '../AccountDetailsRecovery/PasswordSetSuccessfully.dart';
              ...
              return Obx(() => Column(
                children: [
                                  ...
                                  children: [
                                    Image.asset(
                                      (controller.arrSelectOptionIcons[2])
                                          ? ImageStyle.password_set_blue
                                          : ImageStyle.passwordSet,
                                      height: 50,
                                    ),
                                    SizedBox(
                                      height: 10,
                  ...
                  if(controller.arrSelectOption[3])
                    Expanded(child: PasswordSetSuccessfully()),
                ],
              ));
            },
          ),
