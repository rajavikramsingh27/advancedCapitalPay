import 'package:advanced_capital_pay/Views/BusinessApplication2.dart';
                             ...
                             'Enter the data requires in sections below to complete your Business Profile',
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: 'The name provided must exactly match t',
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(),
                                  labelText: 'Please enter year of incorporation',
                                  labelStyle: TextStyles.textStyles_14.apply(
                                    color: Colors.grey,
                                    fontWeightDelta: 1,
                                  ),
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(),
                                  labelText: 'Please enter your company registration n',
                                  labelStyle: TextStyles.textStyles_14.apply(
                                    color: Colors.grey,
                                    fontWeightDelta: 1,
                                  ),
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(),
                                  labelText: 'Provide a detailed explanation of the Nature of your business',
                                  labelStyle: TextStyles.textStyles_14.apply(
                                    color: Colors.grey,
                                    fontWeightDelta: 1,
                                  ),
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(),
                                  labelText: 'if application, provide details of your compa',
                                  labelStyle: TextStyles.textStyles_14.apply(
                                    color: Colors.grey,
                                    fontWeightDelta: 1,
                                  ),
                              ...
                              Row(
                                children: [
                                  Expanded(child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      border: OutlineInputBorder(),
                                      labelText: 'please enter your phone E-mail address',
                                      labelStyle: TextStyles.textStyles_14.apply(
                                        color: Colors.grey,
                                        fontWeightDelta: 1,
                                      ),
                              ...
                              Row(
                                children: [
                                  Expanded(child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      border: OutlineInputBorder(),
                                      labelText: 'Enter business website in the format of htt',
                                      labelStyle: TextStyles.textStyles_14.apply(
                                        color: Colors.grey,
                                        fontWeightDelta: 1,
                                      ),
