...
import '../../Controllers/SignUp/SignUpPersonalApplication2Controller.dart';
...
class SignUpPersonalApplication2 extends StatelessWidget {
  SignUpPersonalApplication2({Key? key}) : super(key: key);

  final controller = Get.put(SignUpPersonalApplication2Controller());
    ...
    return Stack(
      children: [
        ...
        Scaffold(
            ...
            body: GetBuilder(
              init: SignUpPersonalApplication2Controller(),
              initState: (state) {
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      child: Row(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          controller.isCheck.value ? Icon(Icons.check_box, color: ColorStyle.primaryWhite,) : Icon(Icons.check_box_outline_blank_sharp, color: ColorStyle.primaryWhite),
                                          SizedBox(
                                            width: 6,
                                          ),
                                          Expanded(child: Text(
                                            'My Correspondence Address is same as my residential address',
